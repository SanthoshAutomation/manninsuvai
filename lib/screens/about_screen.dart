...
class _AboutScreenState extends State<AboutScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            'to modern families.',
            style: GoogleFonts.poppins(fontSize: 14, color: AppColors.textMedium, height: 1.7),
          ),
          const SizedBox(height: 12),
          Text(
  ...
  Widget _buildContactSection(BuildContext context) {
    final contacts = [
      ...
      },
      {
        ...
        'url': 'mailto:manninsuvai25@gmail.com',
      },
      {
        'emoji': '📍',
        'label': 'Address',
        'value': '2/112, Samiyar Colony, Kattalampatti Post,\nSattur Taluk, Virudhunagar, TN - 626203',
        ...
        children: [
          Padding(
            ...
            child: Text('Contact Us',
                style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.w700, color: AppColors.textDark)),
          ),
          ...contacts.map((c) => InkWell(
                onTap: c['url'] != null ? () => _launchUrl(c['url'] as String) : null,
                child: Padding(
  ...
  Widget _buildFssaiSection() {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppColors.secondaryLighter, AppColors.primary.withOpacity(0.2)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(20),
      ...
      child: Column(
        ...
        children: [
          Text('Our Brands',
              style: GoogleFonts.poppins(fontSize: 17, fontWeight: FontWeight.w700, color: AppColors.textDark)),
          const SizedBox(height: 12),
          _brandCard('🌾', 'Mannin Suvai', 'Traditional Homemade Health Mixes',
              'Premium health mixes from traditional rice, millets, pulses, dry fruits & spices. FSSAI certified.',
              AppColors.secondaryLighter, AppColors.secondary),
          const SizedBox(height: 12),
          _brandCard('🌸', 'Azhagiya Amudham', 'Traditional Herbal Beauty Care',
              'Natural herbal products using traditional recipes for skin & hair. Safe for kids & family.',
              AppColors.pinkLight, AppColors.beauty),
          const SizedBox(height: 12),
          _brandCard('🍵', '7th Heaven Valparai', "Nature's Best Tea",
              'Premium tea directly from the lush gardens of Valparai — finest tea-growing region in Tamil Nadu.',
              AppColors.amberLight, AppColors.teaBev),
        ],
      ),
    );
  }

  Widget _brandCard(String emoji, String name, String tagline, String desc, Color bg, Color textColor) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(tagline,
                    style: GoogleFonts.poppins(
                        fontSize: 12, color: textColor.withOpacity(0.8), fontWeight: FontWeight.w600)),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text('TASTE the REAL TASTE of HOMEMADE',
                style: GoogleFonts.poppins(
                    fontSize: 13, color: AppColors.textMedium, fontStyle: FontStyle.italic),
                textAlign: TextAlign.center),
          ],
        ),
      ),
